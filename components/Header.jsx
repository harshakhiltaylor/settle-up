...
const Header = () => {
    ...
    return (
        <header className="fixed top-0 w-full border-b bg-white/95 backdrop-blur z-50 supports-[backdrop-filter]:bg-white/60">
            ...
            <Image src={"/logos/logo.png"} alt="settle-up logo" width={200} height={60} className='h-11 w-auto object-contain'/>
            </Link>

            {path === "/" && (<div className='hidden md:flex items-center gap-6'>
