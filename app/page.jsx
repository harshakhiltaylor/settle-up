  ...
  return (<div className="flex flex-col pt-16">
    <section className="mt-20 pb-12 space-y-10 md: space-x-20 px-5">
      <div className="container mx-auto  px-4 md:px-6 text-center space-y-6">
        ...
        <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed"> Track shared expenses , split bills effortlessly , and settle up quickly ,
         Never worry about who owes who again</p>
         ...
         <div className="container mx-auto max-w-5xl overflow-hidden rounded-xl shadow-xl ">
          <div className="gradient p-1 aspect-[16/9] ">
            <img src="/hero.png" alt="Banner" width={1280} height={720} className="rounded-lg mx-auto" priority/>
          </div>
         </div>
    ...
    <section id="features" className="bg-gray-50 py-20 ">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <h1 className=" gradient-title mx-auto max-w-4xl text-4xl md:text-4xl">Everything you need to spilt expenses</h1>

         <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed"> Our platform provides all the tools you need to handle shared with ease</p>


        <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map(({title , Icon , bg, color , description }) => {

             return  <Card key={title} className="flex flex-col items-center space-y-4 p-6 text-center">
    ...
    <section id="how-it-works" className="bg-gray-50 py-20 ">
      <div className="container mx-auto px-4 md:px-6 text-center">
         <Badge variant="outline" className="bg-green-100 text-green-700">How It Workss</Badge>
      

        <h1 className=" gradient-title mx-auto max-w-4xl text-4xl md:text-4xl">Spliiting Expenses has never been easier</h1>

         <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">Follow these steps to start tracking and Spliiting expenses with friends</p>
     ...
     <section className="bg-gray-50 py-20 ">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <h1 className=" gradient-title mx-auto max-w-4xl text-4xl md:text-4xl">What our users are saying</h1>
